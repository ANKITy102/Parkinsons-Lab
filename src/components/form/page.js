export default function Form() {
  return (
    <section id="form">
      <div className="min-h-screen bg-black p-0 sm:p-12">
        <div className="ml-[4rem] max-w-[60%] px-6 py-12 bg-black border-0">
          <h1 className="text-2xl font-bold mb-8 text-white">DETAILS</h1>
